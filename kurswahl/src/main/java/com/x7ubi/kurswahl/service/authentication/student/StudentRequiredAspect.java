package com.x7ubi.kurswahl.service.authentication.student;
...
public class StudentRequiredAspect {
    ...
    @Pointcut("@annotation(com.x7ubi.kurswahl.service.authentication.student.StudentRequired)")
    private void studentRequiredAnnotation() {
    }

    @Around("com.x7ubi.kurswahl.service.authentication.student.StudentRequiredAspect.studentRequiredAnnotation()")

package com.x7ubi.kurswahl.service.authentication.admin;
...
public class AdminRequiredAspect {
    ...
    @Pointcut("@annotation(com.x7ubi.kurswahl.service.authentication.admin.AdminRequired)")
    private void adminRequiredAnnotation() {
    }

    @Around("com.x7ubi.kurswahl.service.authentication.admin.AdminRequiredAspect.adminRequiredAnnotation()")

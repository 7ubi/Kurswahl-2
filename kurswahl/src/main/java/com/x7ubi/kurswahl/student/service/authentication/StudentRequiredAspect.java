package com.x7ubi.kurswahl.student.service.authentication;
...
public class StudentRequiredAspect {
    ...
    @Pointcut("@annotation(com.x7ubi.kurswahl.student.service.authentication.StudentRequired)")
    private void studentRequiredAnnotation() {
    }

    @Around("com.x7ubi.kurswahl.student.service.authentication.StudentRequiredAspect.studentRequiredAnnotation()")

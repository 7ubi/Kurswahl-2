package com.x7ubi.kurswahl.admin.service.authentication;
...
public class AdminRequiredAspect {
    ...
    @Pointcut("@annotation(com.x7ubi.kurswahl.admin.service.authentication.AdminRequired)")
    private void adminRequiredAnnotation() {
    }

    @Around("com.x7ubi.kurswahl.admin.service.authentication.AdminRequiredAspect.adminRequiredAnnotation()")
